...
import { FaTrophy, FaMedal, FaAward, FaStar, FaArrowRight } from "react-icons/fa";
...
export default function Achievements() {
  ...
  return (
    ...
    >
      ...
      >
        My <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-emerald-600">Achievements</span>
      </motion.h2>
